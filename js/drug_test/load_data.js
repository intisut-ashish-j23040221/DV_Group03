...
Promise.all([
    d3.csv("./data/drug_data.csv", d => ({
        year: +d.YEAR,                                          
        jurisdiction: d.JURISDICTION,                           
        totalConducted: +d.Total_Conducted,                     
        positiveDrugCount: +d.Positive_Drug_Count,          
        percentPositive: +d["% positive drug test results"],
        fines: +d["Sum(FINES)"],
