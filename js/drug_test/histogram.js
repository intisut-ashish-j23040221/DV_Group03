const drawPositiveDrugBar = (data) => {
    ...
    addDataTableContextMenu(container.node(),
        ...
        'Bar chart showing the total positive drug test cases for each jurisdiction in the current filter selection. Hover over bars to see percentage of total cases and rank. Higher ranked jurisdictions have more positive results.',
        (row, clone) => {
            if (!row) {
